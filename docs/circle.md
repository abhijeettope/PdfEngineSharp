...
For details about how to draw Cubic Bezier Curves in PDF refer bellow specifications
<https://opensource.adobe.com/dc-acrobat-sdk-docs/pdfstandards/pdfreference1.4.pdf>
here in Chapter 4, page number 164 you can find how to draw Bezier Curves
for out purpose we will draw curve using 'c' operator
...
and for details about how to approximate cirlce using Cubic Bezier Curve refer bellow linked article
...
For this our first control point will be (x+r*0.55, y+r*0.99) and second control point will be (x+r*0.99, y+r0.55)
...
here we are done drawing arc in first quadrant, in the same way we can draw cirlce for all the quadrants.
but as we are already on +ve X Axis we will draw arc in fourth quadrant
as in fourth quadrant our Y axis is less than y ( codinate of center ) we will subtract r*0.55 and r*0.99 from y
